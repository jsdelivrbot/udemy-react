...
import map from '../src/map-recursive'
...
describe('map', () => {
  ...
  test('map([10,20], (item, i, array) => array) should return [[10,20], [10,20]]', () => {
    expect(map([10,20], (item, i, array) => array)).to.be.deep.equal([[10,20], [10,20]])  
  })
